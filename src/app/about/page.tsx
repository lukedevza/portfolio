    ...
    <MaxWidthWrapper className="sm:overflow-hidden">
      <div className="flex flex-col ">
        ...
        <p className="text-gray-300 ml-8 md:ml-18 text-lg md:text-xl leading-loose">
          ...
          <br />
          I started coding in 2022, and since then I&apos;ve been building projects with React-based
          frameworks like Next.js and React Native, experimenting with creative ways to build web
          and mobile apps.
          ...
          thats why I enjoy web development because it turns ideas into something real and tangible.
          Seeing a finished product at the end of the day is deeply rewarding and fuels my
          creativity.
        </p>
